...
extension UIView {
    ...
    func showToast(_ toast: UIView, duration: Double, position: AnyObject, toastIntention: Int) {
        ...
        toast.layer.borderColor = ColorCode().appThemeColor.cgColor
    ...
    func viewForMessage(_ msg: String?, title: String?, image: UIImage?, toastIntention: Int = 0) -> UIView? {
        ...
        if msg != nil {
            ...
            switch toastIntention {
            case 0 :
                msgLabel!.textColor = ColorCode().redColor
            case 1:
                msgLabel!.textColor = ColorCode().toastGreenColor
            case 2 :
                msgLabel!.textColor = ColorCode().toastGrayColor
            default:
