...
//  Campus Buddy
//
//  Created by Kush Taneja on 05/01/17.
...
class AppDelegate: UIResponder, UIApplicationDelegate{
    ...
    print("noti didRegister notification woth device tocken")
        debugPrint("SUccesfully registered with \(deviceToken)")
        
//        FIRInstanceID.instanceID().setAPNSToken(deviceToken, type: FIRInstanceIDAPNSTokenType.sandbox)
//        let tokenChars = UnsafePointer<Data>(deviceToken)
//        var tokenString = ""
//        
...
//    }
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "Campus_Buddy", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent("Campus_Buddy.sqlite")
...
/*
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Campus_Buddy")
